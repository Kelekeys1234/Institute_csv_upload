...
public class ObjectMapperHelper {
	 ...
	 * @throws IOException
	 */
	public static <T> T readValueFromJSON(String content, TypeReference<T> valueTypeRef) throws IOException {
		return objectMapperWithoutIndentation.readValue(content, valueTypeRef);
	}
